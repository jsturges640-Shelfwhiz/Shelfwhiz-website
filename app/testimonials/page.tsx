...
const testimonials = [
  ...
  },
  {
    ...
    role: "Director of Sales",
    content: "Before my team and I used this service, we would spend a lot of time separating and staging the product.  After using ShelfWhiz, our warehouse time was cut in half.  This service allows us to work more efficiently, and get more locations done per day.  This service is now a must on every changeover.",
    rating: 5,
  ...
  },
  {
    ...
    name: "Jimmy G",
    company: "Dallas, TX",
    role: "Director of Stratigic Accounts",
    content: "ShelfWhiz Mapping program revolutionizes inventory execution. By streamlining the process and eliminating unnecessary product movement, it delivers unmatched efficiency and cost savings.",
    rating: 5,
    image: "/professional-placeholder.jpg",
  },
];
